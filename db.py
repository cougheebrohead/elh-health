"""Vitalstack DB client — same shape as CoachHQ but ctx is org_id, user_id,
...
if not SUPABASE_URL or not SUPABASE_KEY:
    print("[Vitalstack] WARNING: SUPABASE_URL and SUPABASE_SERVICE_KEY required", flush=True)
...
def _request(method: str, path: str, body: dict | None = None) -> Any:
    ...
    try:
        ...
        print(f"[Vitalstack] PostgREST {e.code}: {msg}", flush=True)
        raise
